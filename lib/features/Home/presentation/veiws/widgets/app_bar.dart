  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: ListTile(
        ...
        leading:  GestureDetector(onTap: (){},child: SvgPicture.asset(Assets.assetsImagesMenuIcon)),
        title: Text.rich(
         TextSpan(children: [
          TextSpan(text: 'e7tar ',style: AppTextStyle.semiBoldMerienda16),
          TextSpan(text: '& ', style: AppTextStyle.semiBoldMerienda16.copyWith(color: AppColor.kPrimaryColor)),
